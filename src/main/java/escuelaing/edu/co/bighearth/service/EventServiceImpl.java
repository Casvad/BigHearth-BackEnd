...
public class EventServiceImpl implements EventService{
    ...
    private void populateSampleData() {
        ...
        "para su mejora formativa y laboral, tiene una duración de una hora y se imparte solo un día a la semana.", new Date(2018),blop,voluntieers,localitation));
        ...
        "con problemas de integración familiar, escolar y social.", new Date(2018), blop,voluntieers,localitation));
        ...
        new Date(2018), blop,voluntieers,localitation));
